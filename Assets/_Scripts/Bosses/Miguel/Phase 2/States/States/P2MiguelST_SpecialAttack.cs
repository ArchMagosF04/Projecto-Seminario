...
public class P2MiguelST_SpecialAttack : P2MiguelState
{
    ...
    public P2MiguelST_SpecialAttack(Phase2MiguelController controller, StateMachine stateMachine, LuisStats stats, Animator anim, string animBoolName) : base(controller, stateMachine, stats, anim, animBoolName)
    {
    }
