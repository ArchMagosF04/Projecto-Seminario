...
public class OnBeatIndicator : MonoBehaviour
{
    ...
    [SerializeField] private bool durationProportionalToBeatDuration = true;
    ...
    {
        BeatManager.Instance.OnCorrectBeat += ShowIndicator;
    }
    ...
    private IEnumerator FadeInOutCoroutine()
    {
        ...
        while (elapsedTime < duration)
        {
            ...
            image.alpha = Mathf.Clamp01(curveValue);
