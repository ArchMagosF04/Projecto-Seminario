...
public class AfterImage : MonoBehaviour
{
    ...
    [SerializeField] private bool applyCustomColor = false;
    [SerializeField] private Color customTrailColor = Color.white;
    ...
    private void CopySpriteRenderer(SpriteRenderer copy, SpriteRenderer original)
    {
        ...
        if (applyCustomColor) copy.color = customTrailColor;
    }
}
