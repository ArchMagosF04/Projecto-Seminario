...
public class GardelST_Airborne : GardelState
{
    ...
    public GardelST_Airborne(GardelController controller, StateMachine stateMachine, GardelStats stats, Animator anim, string animBoolName) : base(controller, stateMachine, stats, anim, animBoolName)
    {
